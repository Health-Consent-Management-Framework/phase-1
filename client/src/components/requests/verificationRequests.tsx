...
const ReportRequest:React.FC = ()=>{
    ...
    useEffect(()=>{
        console.log(verficationRequests)
    },[verficationRequests])
    ...
    return(
        <section className="w-full">
            <div className="w-full flex items-center justify-between">
                ...
                <LabeledSelect onChange={(e)=>{setType(e.value)}} label="Type" options={[{name:"verfifcation",value:"verification"},{name:"access",value:"access"}]}/>
            </div>
