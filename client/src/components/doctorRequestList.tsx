    ...
    return(
        <section className='relative max-w-[1000px] w-screen overflow-y-auto flex flex-col max-h-[500px] h-[95vh] bg-emerald-200'>
            ...
            <div className="border-b-2 flex justify-between p-2 px-10">
                ...
                <Button onClick={submitRequest} className="border-blue-600 outline-blue-200 bg-blue-500 flex items-center gap-2 font-medium text-slate-100 hover:border-blue-300 hover:bg-blue-200 hover:text-blue-700">Request Access</Button>
            </div>
